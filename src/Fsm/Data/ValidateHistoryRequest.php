...
/**
 * Request DTO for validating FSM transition history.
 *
 * Validates and structures the input parameters required to check
 * the consistency and validity of transition history.
 */
class ValidateHistoryRequest extends Dto
{
