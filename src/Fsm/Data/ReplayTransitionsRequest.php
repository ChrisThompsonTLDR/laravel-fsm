...
/**
 * Request DTO for replaying FSM transitions.
 *
 * Validates and structures the input parameters required to replay
 * transitions for deterministic state reconstruction.
 */
class ReplayTransitionsRequest extends Dto
{
