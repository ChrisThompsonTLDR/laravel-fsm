...
/**
 * Test that RunActionJob correctly incorporates the model in TransitionInput.
 ...
 */
class RunActionJobModelExtractionBugFixTest extends FsmTestCase
{
    #[Test]
    public function it_correctly_incorporates_model_in_transition_input(): void
    {
        ...
        $job = new RunActionJob(
            callable: TestActionClassModelExtraction::class.'@handle',
        ...
        App::shouldReceive('call')
            ->once()
            ->with(
                TestActionClassModelExtraction::class.'@handle',
            ...
            ->with(
                ...
                \Mockery::on(function ($args) use ($model) {
                    return isset($args['input']) && $args['input'] instanceof TransitionInput
                        ...
                        && $args['input']->metadata['action'] === 'action'
    ...
    #[Test]
    public function it_normalizes_callable_with_double_colon_syntax(): void
    {
        $model = TestModel::factory()->create();
        ...
        App::shouldReceive('call')
            ->once()
            ->with(
                TestActionClassModelExtraction::class.'@handle', // Should be normalized to @ syntax
                \Mockery::on(function ($args) use ($model) {
                    return isset($args['input']) && $args['input'] instanceof TransitionInput
                        && $args['input']->model->is($model);
                })
 ...
 */
class TestActionClassModelExtraction
{
